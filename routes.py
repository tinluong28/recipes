...
from controller_functions import index, register, login, dashboard, logout, create, create_recipe, review, all_users_review, display_instruction, delete_recipe, verify_username, verify_email, like_recipe, unlike_recipe
...
app.add_url_rule('/email', view_func=verify_email, methods=['POST'])
